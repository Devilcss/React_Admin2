    ...
    return (
      <div className='home'>
        <Card
          className="home-card"
          title="商品总量"
          extra={<LockOutlined style={{color: 'rgba(0,0,0,.45)'}} type="question-circle"/>}
          style={{width: 250}}
        ...
        >
          ...
          <Statistic
            ...
            prefix={'周同比'}
            suffix={<div>%<LockOutlined style={{color: 'red', marginLeft: 10}} type="arrow-down"/></div>}
          />
          <Statistic
            value={10}
            valueStyle={{fontSize: 15}}
            prefix={'日同比'}
            suffix={<div>%<LockOutlined style={{color: '#3f8600', marginLeft: 10}} type="arrow-up"/></div>}
          />
        </Card>
        ...
        >
          <Card
            ...
            extra={<LockOutlined type="reload"/>}
          >
            <Bar/>
          </Card>

          <Card title='任务' extra={<LockOutlined type="reload"/>} className="home-table-right">
            <Timeline>
